...
Cuando hayamos acabado todo el preprocessing:

Save clean dataset into an R object:

```{r}
df_clean <- df %>% dplyr::select(-month)
dir.create("../artifacts", showWarnings = FALSE)
save(df_clean, file = "../artifacts/df_clean.RData")
```
